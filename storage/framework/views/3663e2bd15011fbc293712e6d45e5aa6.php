                    ...
                    <form action="/sell" method="POST" class="mb-4">
                        ...
                        <div class="mt-3 newCard p-4">
                            <div class=" d-flex justify-content-between ">
                                ...
                                <div>
                                    <a class=" btn btn-info text-light" href="<?php echo e(url('transactions')); ?>">All
                                        Transactions</a>
                                </div>
                            </div>
                            <hr>
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="productID" id="productID" onchange="calculateTotal()"
                                    ...
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option data-selectprice="<?php echo e($product->price); ?>" data-unit="<?php echo e($product->unit); ?>"
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mdtau\Downloads\Compressed\module-11-main\resources\views/MakeTransaction.blade.php ENDPATH**/ ?>