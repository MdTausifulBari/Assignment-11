                    ...
                    <div class="col-md-6">
                        <div class="loginCard">
                            ...
                            <div id="adminForm">
                                ...
                                <form action="<?php echo e(url('/registration')); ?>" class="loginForm" method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\mdtau\Downloads\Compressed\module-11-main\resources\views/Register.blade.php ENDPATH**/ ?>